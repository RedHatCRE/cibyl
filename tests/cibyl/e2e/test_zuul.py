...
class TestQueryLevel(EndToEndTest):
    ...
    def test_get_jobs(self):
        ...
        self.assertIn(
            "Total jobs found in query for tenant 'example-tenant': 67",
            self.stdout
        )
...
class TestQueryComposing(EndToEndTest):
    ...
    def test_tenants_with_jobs(self):
        ...
        expected1.add('Summary: ', 4)
        expected1.add('.', 5)
        expected1.add('+-- build-docker-image', 5)
        expected1.add('In detail: ', 4)
        expected1.add('Job: build-docker-image', 5)
    ...
    def test_projects_with_jobs(self):
        ...
        expected2.add('Summary: ', 4)
        expected2.add('.', 5)
        expected2.add('+-- build-docker-image', 5)
        expected2.add('In detail: ', 4)
        expected2.add('Job: build-docker-image', 5)
...
class TestOthers(EndToEndTest):
    ...
    def test_jobs_are_alphabetically_ordered(self):
        ...
        expected = IndentedTextBuilder()
        expected.add('Job: nodejs-npm', 5)
        expected.add('Job: nodejs-npm-run-docs', 5)
        expected.add('Job: nodejs-npm-run-lint', 5)
        expected.add('Job: nodejs-npm-run-test', 5)
        expected.add('Job: nodejs-run-docs', 5)
        expected.add('Job: nodejs-run-lint', 5)
        expected.add('Job: nodejs-run-test', 5)
        expected.add('Job: nodejs-run-test-browser', 5)
