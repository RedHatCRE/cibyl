...
class TestDeploymentGenerator(TestCase):
    ...
    def test_finds_variants_release(self):
        """Checks that the release of the variant is searched in order to
        ...
        deployment = generator.generate_deployment_for(variant)
